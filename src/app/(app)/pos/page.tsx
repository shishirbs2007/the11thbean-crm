...
import { startOfTodayISO, sumOrderTotals } from "@/lib/pos/totals";
...
export default async function PosPage() {
  ...
  const todayOrders = ((todayRows ?? []) as { total: number | string }[]).map(
    (o) => ({ total: Number(o.total) }),
  );
  const todayTotal = sumOrderTotals(todayOrders);
